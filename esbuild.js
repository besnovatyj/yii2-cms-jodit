...
// jodit и @besnovatyj/filemanager-core БАНДЛЯТСЯ внутрь (self-contained виджет).
// CSS Jodit импортируется в entry и выезжает отдельным файлом dist/jodit-widget.css.
//#####################################
...
const buildOptions = {
  ...
  platform: 'browser',
  sourcemap: true,
  // Ничего наружу не выносим: виджет самодостаточен (jodit + ядро ФМ внутри бандла).
  external: [],
  loader: {
